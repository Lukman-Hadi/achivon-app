...
class Admin extends CI_Controller {
	...
	public function index(){
		...
		$data['data']['total_jenis_barang'] = 0;
		$data['data']['total_stock'] = 0;
		$data['data']['barang_hampir_habis'] = 0;
		$data['data']['barang_kadaluarsa'] = 0;
		$data['data']['paling_banyak_terjual'] = 0;
		$data['data']['paling_banyak_stock'] = 0;
